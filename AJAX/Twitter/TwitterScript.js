...
// Функція для отримання списку публікацій з сервера
function getPosts() {
...
// Функція для відображення публікацій
...
function createCard(post, user) {
    ...
    editBtn.addEventListener('click', () => openEditModal(post.id, post.title, post.body));
...
// Функція для відкриття модального вікна для створення публікації
function openCreateModal() {
    const modal = document.getElementById('createModal');
    modal.style.display = 'block';
}

// Функція для закриття модального вікна для створення публікації
function closeCreateModal() {
    const modal = document.getElementById('createModal');
    modal.style.display = 'none';
}

// Функція для створення нової публікації
...
// Функція для відкриття модального вікна для редагування публікації
...
// Функція для закриття модального вікна для редагування публікації
function closeEditModal() {
    const modal = document.getElementById('editModal');
    modal.style.display = 'none';
}

// Функція для оновлення публікації
...
// Отримати дані про користувачів та публікації, і відобразити їх на сторінці
...
// Додати обробник події для кнопки "Додати публікацію"
document.getElementById('addPostBtn').addEventListener('click', openCreateModal);

// Додати обробник події для кнопки "Close" у модальному вікні для створення публікації
document.getElementById('createClose').addEventListener('click', closeCreateModal);

// Додати обробник події для кнопки "Create" у модальному вікні для створення публікації
...
// Додати обробник події для кнопки "Close" у модальному вікні для редагування публікації
