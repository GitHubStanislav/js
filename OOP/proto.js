...
// Кожен об'єкт має посилання на свій прототип, який можна використовувати для доступу до властивостей та методів, що визначені в прототипі.
// При створенні нового об'єкта можна вказати його прототип за допомогою методу Object.create().
